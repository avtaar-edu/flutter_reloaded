...
class collegeButton extends StatelessWidget {
  ...
  const collegeButton({super.key, required this.text, required this.onPressed, this.isSelected=false});
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
     ...
     SizedBox(height: 30,),
 SvgPicture.asset('assets/profile_college.svg',height: 80,),

 
 SizedBox(height: 22),
        Text("I am in college",style:TextStyle(
        fontSize: 10  ,
