...
class transitButton extends StatelessWidget {
  ...
  const transitButton({super.key, required this.text, required this.onPressed, this.isSelected=false});
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
     ...
     SizedBox(height: 30,),
 SvgPicture.asset('assets/profile_transition.svg',height: 80,),

 
 SizedBox(height: 22),
        Text("I am in transition",style:TextStyle(
        fontSize: 10  ,
