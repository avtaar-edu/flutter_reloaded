...
class CustomSelectBoxYear extends StatefulWidget {
  final String text;
  ...
  const CustomSelectBoxYear(
     ...
     this.isSelected = false,
      ...
      this.padding = true});
  @override
  _CustomSelectBoxYearState createState() => _CustomSelectBoxYearState();
}

class _CustomSelectBoxYearState extends State<CustomSelectBoxYear> {
  @override
      ...
      child: Container(
        ...
        padding: widget.padding
            ? EdgeInsets.symmetric(
                horizontal: size.width * 0.05, vertical: size.height * 0.014)
            : null,
